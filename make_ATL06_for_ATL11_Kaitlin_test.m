...
out_top='/Volumes/ice1/ben/temp/PIG_Collab_v13A/';
replace=true;
    ...
    for k_rep=1:Nreps
        ...
        for kT=1:length(Tracks)
            ...
            for this_pair=1:3
                ...
                ATL06_struct=ATL06_structure_gen_original(ATL06_struct,D3, dh_hist,  this_pair); 
            end
            dump_struct_to_h5(ATL06_struct, out_file,'/');
        end
    end
end
