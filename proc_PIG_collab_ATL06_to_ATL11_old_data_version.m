...
IS_paths.ATL06='/Volumes/ice1/ben/sdt/ATLxx_example/PIG_Collab_v13B_NoFirn_NoDz/ATL06';
IS_paths.ATL11='/Volumes/ice1/ben/sdt/ATLxx_example/PIG_Collab_v13B_NoFirn_NoDz/ATL11/';
    ...
    for kT=1:length(TrackList)
        ...
        for kP=1:3
            ...
            for kR=1:Nreps
                ...
                ATL06_file=sprintf('%s/run_%d/rep_%d/Track_%d-Pair_%d_D3.h5', IS_paths.ATL06, run_num, kR, TrackList(kT), kP);
                ...
                D3temp.azimuth=interp1(GroundTracks(TrackList(kT)).x_RGT, GroundTracks(TrackList(kT)).azimuth, D3temp.x_RGT);
            ...
            [D3.x_PS_ctr, D3.y_PS_ctr]=ll2ps(D3.lat_ctr, D3.lon_ctr);
            D3.time=D3.time;
