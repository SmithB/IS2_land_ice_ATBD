function [D_06, dh_hist, D_03]=atl03_to_atl06_08_flags(fname, pair, SNR_F_table_file, out_dir, which_seg)
...
for kP=pair(:)'
    ...
    for k0=1:length(ID0)-1
        ...
        % map all signal_conf_ph > 0 to 3
        for kk=1:length(D_03)
            D_03(kk).signal_conf_ph(D_03(kk).signal_conf_ph>0)=3;
        end
