function varargout=make_fpb_test_data_for_ATL06_paper_full_det_model_WF(varargin)
...
Rsurf0=[0.125:0.125:2.5];
BGR=0;%1e5;%1e7;
test_data_dir=['/home/ben/temp/deadtime_correction_data/tdead_dig=3.2ns.t_dead_analog=1ns_WF'];
...
if exist(D3_file,'file'); return; end
...
thedir=['/home/ben/temp/deadtime_correction_data/tdead_dig=3.2ns.t_dead_analog=1ns_WF/D3/'];
%thedir='/Volumes/insar7/ben/deadtime_correction_data/tdead=3.2_0MHz/D3/';
[Rough, Rsurf, U, C]=make_fpb_test_data_for_ATL06_paper_full_det_model_WF('report_errors', thedir);
figure(51); clf;
...
%-----------------------------------------------
function EnergySetting4
thedir=['/home/ben/temp/deadtime_correction_data/tdead_dig=3.2ns.t_dead_analog=1ns_WF/D3/'];
[Rough, Rsurf, U, C]=make_fpb_test_data_for_ATL06_paper_full_det_model_WF('report_errors', thedir);



figure(11); clf; hold on; set(gca,'defaultlinelinewidth', 2); 
plot(Rsurf(1,:)*.75, U(2).N(1,:)/16/57);
plot(0.75*[1 1], get(gca,'ylim'),'k')
plot(get(gca,'xlim'), 0.56*[1 1],'k')
xlabel('ph/pulse/pix in');
ylabel('ph/pulse/pix out');
plot(get(gca,'xlim'), [1 1]*0.7,'--','color', [.7 .7 .7]);
plot(1.15*[1 1], get(gca,'ylim'),'k--')
plot([0 1], [0 1], 'r:');
...
figure(12); clf;
plot( Rsurf(1,:)*.75, U(2).N(1,:)/16/57./(Rsurf(1,:)*.75));
hold on;
set(gca,'ylim', [0 1]);
plot(0.75*[1 1], get(gca,'ylim'),'k')
plot(1.15*[1 1], get(gca,'ylim'),'k--')
